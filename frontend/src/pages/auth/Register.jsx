                ...
                <div>
                  ...
                  <motion.div whileHover={{ scale: 1.01 }} className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 shadow-sm pr-10`}
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
